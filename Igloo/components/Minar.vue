<template>
    <div class="bg-slate-300 h-screen overflow-hidden flex items-center justify-center">
  <div class=" rounded-xl bg-purple-500 lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
