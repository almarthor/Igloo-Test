        ...
        <div class=" border w-full overflow-hidden mb-5 cursor-pointer h-auto rounded-md">
          <div class="md:flex max-h-full inline-block">
            ...
            <div class=" p-4 flex flex-col w-full">
              ...
              <div class="flex justify-between items-center">
                <p class=" text-[11px] text-neutral-600 font-light">Toyota 2 LIFT DECEMBER XT5</p>
                  <p class=" text-[14px] mb-[2px] text-[rgba(58,60,62,255)]">Good price <Icon name="fe:info" class="mb-1"/></p>
                </div>
                <div class="flex justify-end">
                  <button class="border rounded-md bg-[rgba(198,227,191,255)] text-xs h-2 w-[29px]"></button>
                  <button class="ml-px border rounded-md bg-[rgba(140,199,125,255)] text-xs h-2 w-[29px]"></button>
                  <button class="ml-px border rounded-md bg-[rgba(81,131,68,255)] text-xs h-2 w-[29px]"></button>
                </div>
                <div class="flex justify-between mt-3">
                  <div class="flex">
                    <p class=" text-xs text-neutral-600"><icon name="icon-park-outline:road" class=" mr-1 text-lg"/>87 356</p>
